    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          {/* Card: Control Despiece (solo admin+) - verificar módulo */}
          {hasModulo('despiece') && (user.rol === 'sysowner' || user.rol === 'admin' || user.rol === 'owner') && (
            <div 
              className="bg-white rounded-2xl shadow-md p-6 hover:shadow-xl hover:scale-[1.02] transition-all duration-300 cursor-pointer border border-gray-100 group"
            ...
            >
              ...
              <p className="text-gray-600">
                Ver despiece del equipo
              </p>
            </div>
          )}

          {/* Card: Mis Despieces (para usuarios normales) - verificar módulo */}
          {hasModulo('despiece') && user.rol === 'user' && (
            ...
            >
              ...
              <p className="text-gray-600">
                Ver y gestionar mis piezas despiezadas
              </p>
            </div>
          )}
          ...
          {/* Card: Monitor de API (Solo Sysowner) */}
          {user.rol === 'sysowner' && (
            <div
              className="bg-white rounded-2xl shadow-md p-6 hover:shadow-xl hover:scale-[1.02] transition-all duration-300 cursor-pointer border border-gray-100 group"
            ...
            >
              ...
              <p className="text-gray-600">
                Peticiones en tiempo real y estadísticas
              </p>
            </div>
          )}
          ...
          >
            <div className="w-12 h-12 mb-3 p-2.5 rounded-xl bg-pink-50 text-pink-600 group-hover:bg-pink-100 transition-colors">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" d="M16.5 6v.75m0 3v.75m0 3v.75m0 3V18m-9-5.25h5.25M7.5 15h3M3.375 5.25c-.621 0-1.125.504-1.125 1.125v3.026a2.999 2.999 0 0 1 0 5.198v3.026c0 .621.504 1.125 1.125 1.125h17.25c.621 0 1.125-.504 1.125-1.125v-3.026a2.999 2.999 0 0 1 0-5.198V6.375c0-.621-.504-1.125-1.125-1.125H3.375Z" />
              </svg>
            </div>
            <h2 className="text-xl font-bold text-gray-900 mb-2">
              {user.rol === 'sysowner' ? 'Gestión Tickets' : 'Soporte'}
            </h2>
            <p className="text-gray-600">
