    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          {/* Card: Fichadas (solo admin+) - verificar mÃ³dulo */}
          ...
          {/* Card: Mis Fichadas (para usuarios normales) - verificar mÃ³dulo */}
          ...
          {/* Card: Cruce de Referencias - verificar mÃ³dulo */}
          {hasModulo('referencias') && (
            ...
            >
              ...
              <p className="text-gray-600">
                OEM â†’ IAM equivalentes
              </p>
            </div>
          )}

          {/* Card: GestiÃ³n Piezas Nuevas - verificar mÃ³dulo */}
          ...
          {/* Card 2: Stock Masivo - verificar mÃ³dulo */}
          ...
          {/* Card: Stockeo AutomÃ¡tico (Solo Sysowner) */}
          {user.rol === 'sysowner' && (
            <div
              className="bg-white rounded-lg shadow p-6 hover:shadow-lg transition-shadow cursor-pointer border-2 border-amber-200"
            ...
            >
              ...
              <p className="text-gray-600">
                ImportaciÃ³n CSV por empresa
              </p>
            </div>
          )}

          {/* Card: Logs de AuditorÃ­a (Solo Sysowner) */}
          {user.rol === 'sysowner' && (
            <div
              className="bg-white rounded-lg shadow p-6 hover:shadow-lg transition-shadow cursor-pointer"
          ...
          {/* Card: Estudio Coches (Solo Admin, Owner, Sysowner) - verificar mÃ³dulo */}
          {hasModulo('estudio_coches') && (user.rol === 'sysowner' || user.rol === 'admin' || user.rol === 'owner') && (
            ...
            >
              ...
              <p className="text-gray-600">
                AnÃ¡lisis por marca y modelo
              </p>
            </div>
          )}

          {/* Card: ConfiguraciÃ³n de Precios (Todos los usuarios) */}
          <div
            className="bg-white rounded-lg shadow p-6 hover:shadow-lg transition-shadow cursor-pointer"
          ...
          {/* Card 6: Historial de Ventas - verificar mÃ³dulo */}
          {hasModulo('ventas') && (
            <div
              className="bg-white rounded-lg shadow p-6 hover:shadow-lg transition-shadow cursor-pointer"
            ...
            >
              ...
              <p className="text-gray-600">
                Piezas vendidas y estadÃ­sticas
              </p>
            </div>
          )}

          {/* Card 7: Inventario de Piezas (Todos los usuarios) - verificar mÃ³dulo */}
